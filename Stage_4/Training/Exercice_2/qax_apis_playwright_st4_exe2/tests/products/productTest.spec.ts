// qax_apis_playwright_st4_exe2/tests/products/productTest.spec.ts

import { test, expect } from '@playwright/test';
import { ProductService } from '../../src/services/ProductService';
import { ProductRequestBody } from '../../src/types/modelos';

test.describe.serial('Products API con TypeScript y data quemada @products y loggs helper', () => {
